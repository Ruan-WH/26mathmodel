// File: comsol_q4/near_surface_check/graded80/Q4Automation.java
...
public class Q4Automation {
  ...
  public static Model build() throws java.io.IOException {
    ...
    double[] locations = new double[81];
    for(int i=0;i<=80;i++) locations[i]=0.5*(1-Math.cos(Math.PI*i/80));
