// File: comsol_q4/near_surface_check/graded320_tight/Q4Automation.java
...
public class Q4Automation {
  ...
  public static Model build() throws java.io.IOException {
    ...
    model.component("comp1").mesh("mesh1").feature("map1").create("rad", "Distribution");
    model.component("comp1").mesh("mesh1").feature("map1").feature("rad").selection().set(new int[]{2,3});
    double[] locations = new double[321];
    for(int i=0;i<=320;i++) locations[i]=0.5*(1-Math.cos(Math.PI*i/320));
    model.component("comp1").mesh("mesh1").feature("map1").feature("rad").set("explicit",locations);
    model.component("comp1").mesh("mesh1").feature("map1").create("ax", "Distribution");
    model.component("comp1").mesh("mesh1").feature("map1").feature("ax").selection().set(new int[]{1,4});
    model.component("comp1").mesh("mesh1").feature("map1").feature("ax").set("numelem",4);
