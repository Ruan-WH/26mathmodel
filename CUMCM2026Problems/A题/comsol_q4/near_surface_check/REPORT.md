...
|---|---:|---:|---:|---:|---:|
| original_dense | original_auto3 | 1e-4 | 0.011729211 | 24.0000 | 0.988 |
| original_tight | original_auto3 | 1e-6 | 0.011735149 | 24.0000 | 0.988 |
| graded80 | 80 | 1e-6 | 4.5173551e-05 | 6.0000 | 0.006 |
| graded160 | 160 | 1e-6 | 4.5323749e-05 | 6.0000 | 0.006 |
| graded320 | 320 | 1e-6 | 4.1881959e-05 | 6.0000 | 0.006 |
| graded320_tight | 320 | 1e-7 | 4.5445337e-05 | 6.0000 | 0.006 |

## COMSOL 自身网格与容差变化

| 比较 | 最大水分差 kg/kg | 最大温差 °C |
|---|---:|---:|
| original_dense → original_tight | 0.00032769189 | 1.534836e-05 |
| original_tight → graded80 | 0.011754515 | 1.9959698e-07 |
| graded80 → graded160 | 1.0579502e-05 | 6.2796929e-08 |
| graded160 → graded320 | 3.4419275e-06 | 3.1212082e-09 |
| graded320 → graded320_tight | 3.5636165e-06 | 4.7239347e-08 |
...
最细且更紧容差组在主模型达标时刻的中心水分为 0.1499988799 kg/kg，表面水分为 0.0526199624 kg/kg。

按已保存输出线性插值得到的 COMSOL 达标时间估计为 51.08709459 h；此值不是内部事件求根结果，不应据此宣称秒以下的预测精度。
