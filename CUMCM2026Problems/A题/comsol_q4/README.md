...
- 主模型给定的第四问判据时刻：50.8213346 h；这里比较该时刻的浓度，未独立求解 COMSOL 首达时间。
- 此时半径：1.200 cm。
- COMSOL 中心含水率：0.149995 kg/kg；表面含水率：0.052060 kg/kg。
- 与完整 161 节点有限体积解在六个相同时刻、101 个径向点比较，最大含水率绝对差为 0.011645 kg/kg，位于 24 h、r/R=0.99；最大温度绝对差为 0.000418 °C。近表层偏差仍需进一步网格检验。
